...
class ProductosProvider {
  ...
  //edita un producto
  Future<LinkedHashMap<String, dynamic>> productosEditar(
      String cod_producto, String cod_producto_nuevo, String nombre, int stock, int precio) async {
